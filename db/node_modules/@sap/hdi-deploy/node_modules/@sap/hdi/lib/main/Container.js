 ...
 */
function connect(hc_connection, credentials){
  return function(callback){
    hc_connection.connect(credentials, callback);
  };
}
...
class Container extends HDIBase {
   ...
   */
  constructor(containerName, credentials, paramSchema) {
    ...
    this.lock = (timeout, params, cb) => {
      ...
      const fn = (callback) => {
        ...
        async.series([
          connect(this.lock_connection, credentials),
